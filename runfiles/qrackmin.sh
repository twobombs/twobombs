...
docker build --no-cache -f dockerfiles/Dockerfile-qimcifa . -t twobombs/qrackmin:qimcifa > qrackmin:qimcifa && docker tag twobombs/qrackmin:qimcifa $HOSTNAME:5000/twobombs/qrackmin:qimcifa && docker push $HOSTNAME:5000/twobombs/qrackmin:qimcifa
