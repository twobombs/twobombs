...
docker build --no-cache -f dockerfiles/Dockerfile-aws . -t twobombs/qrackmin:aws > qrackmin:aws && docker tag twobombs/qrackmin:aws $HOSTNAME:5000/twobombs/qrackmin:aws
docker push $HOSTNAME:5000/twobombs/qrackmin:aws &
docker build --no-cache -f dockerfiles/Dockerfile-braket . -t twobombs/qrackmin:braket > qrackmin:braket && docker tag twobombs/qrackmin:braket $HOSTNAME:5000/twobombs/qrackmin:braket
docker push $HOSTNAME:5000/twobombs/qrackmin:braket &

docker build --no-cache -f dockerfiles/Dockerfile-cuda . -t twobombs/qrackmin:cuda > qrackmin:cuda && docker tag twobombs/qrackmin:cuda $HOSTNAME:5000/twobombs/qrackmin:cuda
docker push $HOSTNAME:5000/twobombs/qrackmin:cuda &
docker build --no-cache -f dockerfiles/Dockerfile-pocl . -t twobombs/qrackmin:pocl > qrackmin:pocl docker tag twobombs/qrackmin:pocl $HOSTNAME:5000/twobombs/qrackmin:pocl
docker push $HOSTNAME:5000/twobombs/qrackmin:pocl &
docker build --no-cache -f dockerfiles/Dockerfile-pyqrack . -t twobombs/qrackmin:pyqrack > qrackmin:pyqrack && docker tag twobombs/qrackmin:pyqrack $HOSTNAME:5000/twobombs/qrackmin:pyqrack
docker push $HOSTNAME:5000/twobombs/qrackmin:pyqrack &
docker build --no-cache -f dockerfiles/Dockerfile-qbdd . -t twobombs/qrackmin:qbdd > qrackmin:qbdd && docker tag twobombs/qrackmin:qbdd $HOSTNAME:5000/twobombs/qrackmin:qbdd
docker push $HOSTNAME:5000/twobombs/qrackmin:qbdd &
